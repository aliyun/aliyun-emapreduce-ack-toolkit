...
public final class Usage {
    ...
    public static void print() {
        ...
        System.out.println(
                "  --class <class name>          Application's main class (required for JAR)");
        ...
        System.out.println(
                "  --py-files <py1,py2>          Comma-separated py files (PySpark only)");
        ...
        System.out.println(
                "  --proxy-user <user>           Proxy user (sets hive.server2.proxy.user)");
        System.out.println(
                "  --deploy-mode <mode>          Deploy mode (cluster/client, default: cluster)");
        System.out.println(
                "                                Note: client mode is not supported and will be");
        ...
        System.out.println(
                "  --timeout <seconds>           Timeout for job completion in seconds.");
        System.out.println(
                "                                If exceeded, the job will be killed and exit");
        System.out.println("                                with code 124");
        System.out.println(
                "  --no-driver-log               Do not stream the live Spark driver pod log to the");
        System.out.println(
                "                                console (driver log streaming is on by default for");
        System.out.println(
                "                                batch jobs on Kubernetes; requires Kyuubi 1.12+)");
        System.out.println(
                "  --driver-log-grep <regex>     Only print driver log lines matching the regex");
        System.out.println(
                "                                (e.g. 'WARN|ERROR'). Java regex, substring match.");
        System.out.println(
                "  --driver-log-grep-v <regex>   Drop driver log lines matching the regex");
        System.out.println(
                "                                (e.g. 'TaskSetManager' to hide per-task spam)");
        System.out.println(
                "  -e <sql-string>               Execute the given SQL statement (spark-sql mode)");
        System.out.println(
                "  -f <sql-file>                 Execute SQL from the given file (spark-sql mode)");
        System.out.println(
                "  --session                     Use session mode for SQL (-e/-f) instead of default batch mode.");
        System.out.println(
                "                                Session mode returns query results as a table.");
        System.out.println(
                "  --kyuubi-url <url>            Kyuubi server URL (overrides all other config)");
        System.out.println(
                "  --kyuubi-user <user>          Kyuubi username (overrides all other config)");
        System.out.println(
                "  --kyuubi-password <pwd>       Kyuubi password (overrides all other config)");
        System.out.println("  --config-file <path>          Custom config file path");
        System.out.println("  --help, -h                    Show this help message\n");
        System.out.println("Spark SQL Mode:");
        System.out.println(
                "  Use -e or -f to execute SQL statements via Kyuubi session (like spark-sql).");
        ...
        System.out.println(
                "    spark-submit -f /path/to/query.sql --conf spark.executor.memory=2g\n");
        System.out.println("Configuration:");
        System.out.println(
                "  Configure Kyuubi server connection via one of the following (priority order):\n");
        ...
        System.out.println(
                "       spark.history.server.url=http://your-history-server:port  # Optional\n");
        ...
        System.out.println(
                "     export SPARK_HISTORY_SERVER_URL=http://your-history-server:port  # Optional\n");
        ...
        System.out.println(
                "     -Dspark.history.server.url=http://your-history-server:port  # Optional\n");
