...
public class Config {
    private static final String DEFAULT_CONFIG_FILE =
            System.getProperty("user.home") + "/.spark-submit.conf";
    ...
    /**
     * Apply command-line overrides to configuration. Command-line values have the highest priority,
     * overriding all other sources. Priority order (highest to lowest): 1. Command-line arguments
     * (--kyuubi-url, --kyuubi-user, --kyuubi-password) 2. System properties (-Dkyuubi.server.url)
     * 3. Environment variables (KYUUBI_SERVER_URL) 4. Config file (~/.spark-submit.conf) 5. Default
     * values
     */
    public void applyOverrides(SparkSubmitArgs args) {
        ...
        if (args.getSparkHistoryUrl() != null) {
            ...
            System.err.println(
                    "Info: Spark History URL overridden by --history-url: "
                            + this.sparkHistoryServerUrl);
        }

        // If any command-line override is provided, we're no longer using default config
        if (args.getKyuubiUrl() != null
                || args.getKyuubiUser() != null
                || args.getKyuubiPassword() != null
                || args.getSparkHistoryUrl() != null) {
    ...
    private void loadConfig(String configFile) {
        ...
        System.err.println(
                "  Environment KYUUBI_SERVER_URL: " + (envUrl != null ? envUrl : "(not set)"));
        System.err.println(
                "  System property kyuubi.server.url: "
                        + (propUrl != null ? propUrl : "(not set)"));
        System.err.println(
                "  Config file kyuubi.server.url: " + (fileUrl != null ? fileUrl : "(not set)"));
        ...
        this.serverUrl =
                propUrl != null
                        ...
                        : (envUrl != null
                                ? envUrl
                                : (fileUrl != null ? fileUrl : DEFAULT_SERVER_URL));
        ...
        this.username =
                propUsername != null
                        ...
                        : (envUsername != null
                                ? envUsername
                                : (fileUsername != null ? fileUsername : DEFAULT_USERNAME));
        ...
        this.password =
                propPassword != null
                        ...
                        : (envPassword != null
                                ? envPassword
                                : (filePassword != null ? filePassword : DEFAULT_PASSWORD));
    ...
    public void validateAndPrintWarning() {
        if (usingDefaultConfig) {
            ...
            System.err.println(
                    "      spark.history.server.url=<your-spark-history-server-url>  # Optional");
            ...
            System.err.println(
                    "      export SPARK_HISTORY_SERVER_URL=<your-spark-history-server-url>  # Optional");
            ...
            System.err.println(
                    "      -Dspark.history.server.url=<your-spark-history-server-url>  # Optional");
            System.err.println();
        } else {
